...
def _form_to_config_payload(form) -> dict:
    ...
    payload = {
        ...
        "generation": {
            ...
            "n_kokoro_positive_per_phrase_per_voice": _int("n_kokoro_positive_per_phrase_per_voice", 3),
        ...
        "training": {
            ...
            "min_curve_recall_for_export": _float("min_curve_recall_for_export", 0.60),
            ...
            "min_curve_confirmation_rate_for_export": _float("min_curve_confirmation_rate_for_export", 0.25),
            ...
            "min_tablet_curve_median_peak_for_export": _float("min_tablet_curve_median_peak_for_export", 0.0),
            "min_tablet_curve_p10_peak_for_export": _float("min_tablet_curve_p10_peak_for_export", 0.0),
